      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2 space-y-6">
          ...
          <p className="text-gray-600 leading-relaxed cursor-default">
            Liudmyla Ryboichuk, dentist, specialist representative. Since 2011,
            she has been providing patients with comprehensive dental care. A
            member of the Czech Dental Chamber. She is committed to continuous
            education both in the Czech Republic and abroad. She delivers
            high-quality care with an emphasis on an individual approach.
            Specialization: conservative dentistry, endodontics, prosthetic and
            aesthetic dentistry.
          </p>
